...
namespace Crystal.DNAS1Server.DNAS1.Receive
{
    public class InstallRequest
    {
        ...
        public static InstallRequest? Read(byte[] data)
        {
            try
            {
                return new InstallRequest(data);
            }
            catch (Exception)
            {
                return null;
        ...
        private InstallRequest(byte[] data)
        {
            ...
            using BinaryReader reader = new(mstream);
            {
                ...
                int payloadSize = Utils.SwapEndian(reader.ReadInt32());
